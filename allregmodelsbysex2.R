...
pred.allmodels.bysex=function(train_outcome, train_feat,train_sex,test_outcome, test_feat,test_sex, xgb=F, harm="combat", eb=F, train_site, test_site, model=lm, formula = NULL)
{
